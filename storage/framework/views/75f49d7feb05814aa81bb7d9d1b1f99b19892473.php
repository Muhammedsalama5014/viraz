                ...
                <div class="col-lg-9">
                    ...
                    <article>
                        ...
                        <figure class="figure mt-0 w-100 text-center">
                            <?php if(!empty($blogs->blog_cover_image) && \Storage::exists('uploads/store_logo/'.$blog->blog_cover_image)): ?>
                                <img alt="Image placeholder" src="<?php echo e($imgpath.$blogs->blog_cover_image); ?>" class="img-fluid rounded">
                            <?php else: ?>
                                <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/store_logo/default.jpg'))); ?>" class="img-fluid rounded">
                            <?php endif; ?>
                        </figure>
...
<?php echo $__env->make('storefront.layout.theme1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme1/store_blog_view.blade.php ENDPATH**/ ?>