...
<div class="row">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><?php echo e(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$'); ?></span>
                </div>
                <?php echo e(Form::number('price', null, ['class' => 'form-control','id' => 'monthly_price','min' => '0','placeholder' => __('Enter Price'),'required' => 'required'])); ?>
    ...
    <div class="form-group col-md-6">
        ...
        <?php echo Form::select('duration', $arrDuration, null, ['class' => 'form-control multi-select', 'required' => 'required']); ?>
...
<?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/plans/create.blade.php ENDPATH**/ ?>