                        ...
                        <div class="row">
                            <div class="small-12 large-4 columns">
                                <div class="imageWrapper">
                                    <button class="file-upload btn-primary">
                                        <img src="<?php echo e(asset('assets/img/upload.svg')); ?>" alt="upload" class="img-fluid">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 text-right">
            <div class="form-group">
                <?php echo e(Form::button(__('Save Changes'),array('type'=>'submit','class'=>'btn btn-sm btn-primary rounded-pill mr-auto'))); ?>
...
<?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme10/customer/profile.blade.php ENDPATH**/ ?>