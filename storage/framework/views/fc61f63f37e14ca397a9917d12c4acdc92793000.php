                    ...
                    <div class="col-md-9 col-lg-10">
                        <div class="nav nav-tabs nav-fill border-0" id="nav-tab" role="tablist">
                            <div class="payment-step border border-secondary row no-gutters w-100">
                                <div class="col-sm-4">
                                        <a href="<?php echo e(route('store.cart', $store->slug)); ?>"  class="active-a tab-a border-0 btn btn-block text-secondary m-0 rounded-0">1 -
                                            <?php echo e(__('My Cart')); ?></a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>" class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0">2 -
                                            <?php echo e(__('Customer')); ?></a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="<?php echo e(route('store-payment.payment', $store->slug)); ?>" class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0">3 -
                                    ...
                                    <?php if(!empty($products)): ?>
                                        ...
                                        <?php $__currentLoopData = $products['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($product['variant_id'] != 0): ?>
                                                <tr class="alert border-secondary" data-id="<?php echo e($key); ?>">
                                                    <td class="px-0 border-0">
                                                        <span
                                                            class="badge-circle badge-lg bg-white border border-secondary ml-n3 text-secondary"><?php echo e($counter++); ?></span>
                                                    </td>
                                                    <td class="border-0">
                                ...
                                <div
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>"
                                            class="btn
                                        btn-secondary px-5 rounded-0"><?php echo e(__('Proceed to checkout')); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-md rounded-pill ">
        <div class="modal-content ">
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                    <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>"
                        class="btn btn-secondary ms-2 rounded-pill"><?php echo e(__('Countinue as guest')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('storefront.layout.theme6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme6/cart.blade.php ENDPATH**/ ?>