                                        ...
                                        <div class="border-0 card card-product rounded-0 shadow">
                                            ...
                                            <div class="card-image col-8 mx-auto pt-4 pb-4">
                                                <a
                                                    ...
                                                    <?php if(!empty($latestProduct->is_cover) && \Storage::exists('uploads/is_cover_image/' . $latestProduct->is_cover)): ?>
                                                        <img alt="Image placeholder"
            ...
            <section class="image-with-text pt-md-4 custom-img-text position-relative">
                ...
                <div class="col-md-6 pl-0">
                    <a href="<?php echo e(route('store.product.product_view', [$store->slug, $products_data->id])); ?>">
                        <?php if(!empty($details->is_cover) && \Storage::exists('uploads/is_cover_image/' . $details->is_cover)): ?>
                            <img alt="Image placeholder"
...
<?php echo $__env->make('storefront.layout.theme10', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme10/index.blade.php ENDPATH**/ ?>