                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            <?php if(Auth::user()->type == 'Owner'): ?>
                                ...
                                <a href="#brand-setting" id="site_setting_tab"
                                                ...
                                                <?php $__currentLoopData = \App\Models\Utility::themeOne(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-4 cc-selector mb-2">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row gutters-xs <?php echo e($key == 'theme10' ? 'theme10box' : ''); ?>" id="<?php echo e($key); ?>">
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="colorinput">
                                                                            <input name="theme_color" type="radio"
                                                                                ...
                                                                                class="colorinput-input color-<?php echo e($loop->index++); ?>" <?php echo e((isset($store_settings['store_theme']) && $store_settings['store_theme'] == $css) && $store_settings['theme_dir'] == $key ? 'checked' : ''); ?>>
                                                                ...
                                                                <div class="logo-content mt-4">
                                                                        ...
                                                                        <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
                                                                            <img src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png')); ?>"
                                                                              alt="<?php echo e(config('app.name', 'Storego')); ?>" alt="logo" class="logo logo-lg nav-sidebar-logo">
                                                                            </a>
                                                                </div>
                                                            ...
                                                            <div class=" setting-card">
                                                                <div class="logo-content mt-4">
                                                                    ...
                                                                    <a href="<?php echo e($logo.'logo-light.png'); ?>" target="_blank">
                                                                        <img id="logo-light" alt="your image" src="<?php echo e($logo.'logo-light.png'); ?>" width="170px" class="img_setting">
                                                                    </a>
                                                                </div>
                                                                <div class="choose-files mt-5">
                                                            ...
                                                            <div class=" setting-card">
                                                                <div class="logo-content mt-3">
                                                                    ...
                                                                    <a href="<?php echo e($logo.(isset($logo) && !empty($logo)? $logo :'favicon.png')); ?>" target="_blank">
                                                                        <img alt="your image" src="<?php echo e($logo.'favicon.png'); ?>"   width="50px" height="50px" class=" img_setting favicon" id="faviCon">
                                                                    </a>
                                                                </div>
                                                                <div class="choose-files mt-5">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                <div class=" setting-card">
                                                                    <div class="logo-content mt-3">
                                                                        ...
                                                                        <a href="<?php echo e($s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png')); ?>" target="_blank">
                                                                            <img id="StorelogoOwner" alt="your image" src="<?php echo e($s_logo.(isset($store_settings['logo']) && !empty($store_settings['logo'])? $store_settings['logo']:'logo.png')); ?>"  class="big-logo invoice_logo img_setting" id="storeLogo">
                                                                        </a>
                                                                    </div>
                                                                ...
                                                                <div class=" setting-card">
                                                                    <div class="logo-content mt-3">
                                                                        ...
                                                                        <a href="<?php echo e($s_logo.(isset($store_settings['invoice_logo']) && !empty($store_settings['invoice_logo'])? $store_settings['invoice_logo']:'invoice_logo.png')); ?>" target="_blank">
                                                                            <img id="invoiceOwner" alt="your image" src="<?php echo e($s_logo.(isset($store_settings['invoice_logo']) && !empty($store_settings['invoice_logo'])? $store_settings['invoice_logo']:'invoice_logo.png')); ?>" width="150px" class="big-logo invoice_logo img_setting" id="invoiceLogo">
                                                                        </a>
                                                                    </div>
                                                                    <div class="choose-files mt-4">
                                                            ...
                                                            <div class=" setting-card">
                                                                <div class="logo-content mt-4">
                                                                    ...
                                                                    <a href="<?php echo e($logo.(isset($logo_img) && !empty($logo_img)? $logo_img:'logo-dark.png')); ?>" target="_blank">
                                                                        <img id="blah" alt="your image" src="<?php echo e($logo.(isset($logo_img) && !empty($logo_img)? $logo_img:'logo-dark.png')); ?>" width="150px" class="img_setting">
                                                                    </a>
                                                                </div>
                                                                <div class="choose-files mt-5">
                                                                    <label for="logo_dark">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/settings/index.blade.php ENDPATH**/ ?>