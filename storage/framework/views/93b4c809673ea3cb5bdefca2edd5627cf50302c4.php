            ...
            <nav class="navbar navbar-expand-md navbar-light default">
                <div class="container-fluid pe-2">
                    <a class="navbar-brand" href="#">
                        <img style="width: 110px;" src="<?php echo e($logo.$company_logo); ?>" alt="<?php echo e(config('app.name', 'Storego')); ?>" class="navbar-brand-img auth-navbar-brand">
                    </a>
...
<?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/layouts/auth.blade.php ENDPATH**/ ?>