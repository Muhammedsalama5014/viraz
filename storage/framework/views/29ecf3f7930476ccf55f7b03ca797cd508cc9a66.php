    ...
    <?php if(!empty($cart['products']) || ($cart['products'] = [])): ?>
        <section class="my-cart-section pt-8">
            <div class="container">
                    ...
                    <div class="col-md-9 col-lg-10">
                        <div class="nav nav-tabs nav-fill border-0" id="nav-tab" role="tablist">
                            <div class="payment-step border border-primary row no-gutters w-100 overflow-hidden rounded-pill">
                                <div class="col-sm-4">
                                        <a href="<?php echo e(route('store.cart', $store->slug)); ?>"  class="active-a tab-a border-0 btn btn-block text-primary m-0 rounded-0 rounded-pill">1 -
                                            <?php echo e(__('My Cart')); ?></a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>" class="border-0 tab-a btn btn-block m-0 text-primary rounded-0 rounded-pill">2 -
                                            <?php echo e(__('Customer')); ?></a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="<?php echo e(route('store-payment.payment', $store->slug)); ?>" class="border-0 tab-a btn btn-block m-0 text-primary rounded-0 rounded-pill">3 -
                ...
                <div class="tab-content d-block py-3 px-3 px-sm-0" id="nav-tabContent">
                                    ...
                                    <?php if(!empty($products)): ?>
                                        ...
                                        <?php $__currentLoopData = $products['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($product['variant_id'] != 0): ?>
                                                <tr class="alert border-primary" data-id="<?php echo e($key); ?>">
                                                    <td class="px-0 border-0">
                                                        <span
                                                            class="badge-circle badge-lg bg-white border border-primary ml-n3 text-primary"><?php echo e($counter++); ?></span>
                                                    </td>
                                                    <td class="border-0">
                                                        <?php if(!empty($product['image'])): ?>
                                                            <img alt="" src="<?php echo e($imgpath.$product['image']); ?>"
                                                    ...
                                                    <td class="price border-0">
                                                        <div class="media-body pl-3">
                                                            <span class="mb-2 p-title t-gray"><?php echo e(__('Price')); ?></span>
                                                            <div class="lh-100">
                                                                <span class="font-weight-400 mb-0 p-price text-primary">
                                                                    <?php echo e(\App\Models\Utility::priceFormat($product['variant_price'])); ?></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="qty-box">
                                                    ...
                                                    <td class="border-0">
                                                        <span
                                                            class="font-weight-bold t-gray p-title"><?php echo e(__('Tax')); ?></span>
                                                        <?php
                                                            $total_tax = 0;
                                                        ?>
                                                    ...
                                                    <td class="border-0">
                                                        <span class="p-title text-dark"><?php echo e(__('Total')); ?></span>
                                                        <?php
                                                ...
                                                <tr class="alert border-primary" data-id="<?php echo e($key); ?>">
                                                    ...
                                                    <td class="border-0">
                                                        <?php if(!empty($product['image'])): ?>
                                                            <img alt="Image placeholder"
                                                                src="<?php echo e($imgpath.$product['image']); ?>" class=""
                                                                style="width:50px;">
                                                        <?php else: ?>
                                                            <img alt="Image placeholder"
                                                                src="<?php echo e(asset(Storage::url('uploads/is_cover_image/default.jpg'))); ?>"
                                                    ...
                                                    <td class="price border-0">
                                                        <div class="media-body pl-3">
                                                            ...
                                                            <div class="lh-100">
                                                                <span class="font-weight-400 mb-0 p-price text-primary">
                                                                    <?php echo e(\App\Models\Utility::priceFormat($product['price'])); ?></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="qty-box">
                                ...
                                <div
                                    ...
                                    <?php if($store_settings['is_checkout_login_required'] == null ||
                                        ...
                                        btn-primary px-5 rounded-0"
                                            data-toggle="modal"
                                            data-target="#checkoutModal"><?php echo e(__('Proceed to checkout')); ?></a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>"
                                            class="btn
                                        btn-primary px-5 rounded-0"><?php echo e(__('Proceed to checkout')); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="empty-card-main">
                        ...
                        <div class="bottom-div mt-5">
                            <h4><?php echo e(__('Your card is empty')); ?></h4>
                            <p>
                            ...
                            <a href="<?php echo e(route('store.slug', $store->slug)); ?>" class="btn btn-primary mt-4 rounded-0">
                                <?php echo e(__('Return to shop')); ?> </a>
                        </div>
                    </div>
                </div>
    <?php endif; ?>
            ...
            <div class="modal-body row">
                <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                    <a href="<?php echo e(route('customer.login', $store->slug)); ?>"
                        class="btn btn-secondary btn-light rounded-pill"><?php echo e(__('Countinue to sign in')); ?></a>
                </div>
                <div class="form-group col-6 d-flex justify-content-center col-form-label mb-0">
                    <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>"
                        class="btn btn-primary ms-2 rounded-pill"><?php echo e(__('Countinue as guest')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('storefront.layout.theme10', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme10/cart.blade.php ENDPATH**/ ?>