        ...
        <div class="logo">
            ...
            <center>
                <?php if(isset($store['invoice_logo']) && $store['invoice_logo'] !==''): ?>
                    <img class="mt-2 mb-2" src="<?php echo e($imgpath.$store['invoice_logo']); ?>" alt="Logo" width="120"/>
                <?php else: ?>
    ...
    <div id="bot">
        <div id="table">
            <table>
                ...
                <?php $__currentLoopData = $order_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="service">
...
<?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/orders/receipt.blade.php ENDPATH**/ ?>