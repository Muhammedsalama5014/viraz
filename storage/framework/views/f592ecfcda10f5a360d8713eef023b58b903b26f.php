...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme10/css/swiper.min.css')); ?>" id="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme10/css/all.min.css')); ?>" id="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme10/css/storego.css')); ?>" id="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme10/css/purpose.css')); ?>" id="stylesheet">
    

    <link rel="stylesheet"
        href="<?php echo e(asset('assets/theme10/css/' . (!empty($store->store_theme) ? $store->store_theme : 'light-blue-color.css'))); ?>">
...
<body>
    ...
    <header class="header" id="header-main">
                ...
                <div class="position-relative col-md-10 px-0">
                    <div class="d-block navbar-nav pr-5 pr-md-0">
                        <span class="ls-3 mr-0 navbar-text text-white text-uppercase top-header-text">
                            <b><?php echo e(__('FREE SHIPPING world wide')); ?></b> <?php echo e(__('for all orders over $199')); ?>
        ...
        <nav class="navbar navbar-main navbar-expand-lg navbar-transparent py-3" id="navbar-main">
            <div class="container px-lg-0">
                ...
                <a class="navbar-brand mr-0" href="<?php echo e(route('store.slug', $store->slug)); ?>">
                    <?php if(!empty($store->logo)): ?>
                        <img alt="Image placeholder"
                            src="<?php echo e($s_logo . $store->logo); ?>">
                    <?php else: ?>
                        <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/store_logo/logo7.png'))); ?>">
                    <?php endif; ?>
                </a>
                ...
                <div class="collapse navbar-collapse align-items-start" id="navbar-main-collapse">
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto nav-my-store">
                                    ...
                                    <div class="drop-down__menu-box">
                                        <ul class="drop-down__menu ">
                                            <li data-name="profile" class="drop-down__item text-primary">
                                                <a href="<?php echo e(route('store.slug', $store->slug)); ?>" class="nav-link text-primary">
                        ...
                        <li class="nav-item nav-item p-0">
                            <a href="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>" class="btn btn-primary py-2 text-nowrap"><?php echo e(__('GO TO SHOP')); ?></a>
                        </li>
                    </ul>
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-4">
                        <p class="font-size-12 mt-2">
                            <?php echo e($getStoreThemeSetting[9]['inner-list'][1]['field_default_text']); ?>
                    ...
                    <div class="col-md-2 mt-5">
                        <a class="navbar-brand mr-0 col-md-2 col-6 px-0" href="#">
                            <img alt="Image placeholder"
                                src="<?php echo e($imgpath . $getStoreThemeSetting[9]['inner-list'][0]['field_default_text']); ?>">
                        </a>
                    </div>
                </div>
            <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        <?php for($i = 0; $i < $getStoreThemeSetting[17]['loop_number']; $i++): ?>
                                            <?php if(isset($getStoreThemeSetting[17]['inner-list'][1]['field_default_text']) &&
                                                isset($getStoreThemeSetting[17]['inner-list'][0]['field_default_text'])): ?>
                                                <li class="mr-4">
                                                    <a href="<?php echo e($getStoreThemeSetting[17]['inner-list'][1]['field_default_text']); ?>"
                                                        target="_blank">
    ...
    <script src="<?php echo e(asset('assets/theme10/js/purpose.core.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme10/js/swiper.min.js')); ?>"></script>
    <script href="<?php echo e(asset('assets/theme10/js/storego.js')); ?>"></script>
    <script href="<?php echo e(asset('assets/theme10/js/regular.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/libs/bootstrap-notify/bootstrap-notify.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme10/js/purpose.js')); ?>"></script>
    <script>
        var dataTabelLang = {
            paginate: {
...
<?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/layout/theme10.blade.php ENDPATH**/ ?>