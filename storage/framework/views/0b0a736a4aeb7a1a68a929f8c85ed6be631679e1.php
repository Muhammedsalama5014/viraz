...
<?php $__env->startSection('content'); ?>
        ...
        <div class="swiper-js-container position-relative home-banner">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8 col-xl-6 text-center mx-auto">
                                            <h6 class="font-size-12 font-weight-300 ls-2 mb-3 text-uppercase text-white">
                                                <?php echo e($homepage_header_sub_title); ?></h6>
                                            <h2 class="store-title text-white">
                                                <span class="font-weight-600">
                                                    <?php echo e($homepage_header_text); ?>
            ...
            <?php if($getStoreThemeSetting[0]['section_enable'] == 'on'): ?>
                <ul class="list-unstyled pl-0 m-0 slider-social">
                    ...
                    <?php if(isset($getStoreThemeSetting[1]['homepage-sidebar-social-icon']) ||
                        isset($getStoreThemeSetting[1]['homepage-sidebar-social-link'])): ?>
                        <?php if(isset($getStoreThemeSetting[1]['inner-list'][1]['field_default_text']) &&
                            isset($getStoreThemeSetting[1]['inner-list'][0]['field_default_text'])): ?>
                            <?php $__currentLoopData = $getStoreThemeSetting[1]['homepage-sidebar-social-icon']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon_key => $storethemesettingicon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $getStoreThemeSetting[1]['homepage-sidebar-social-link']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link_key => $storethemesettinglink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <?php for($i = 0; $i < $getStoreThemeSetting[1]['loop_number']; $i++): ?>
                            <?php if(isset($getStoreThemeSetting[1]['inner-list'][1]['field_default_text']) &&
                                isset($getStoreThemeSetting[1]['inner-list'][0]['field_default_text'])): ?>
                                <li class="my-2">
                                    <a class="d-flex align-items-center justify-content-center bg--gray rounded-circle footer-icon"
                                        href="<?php echo e($getStoreThemeSetting[1]['inner-list'][1]['field_default_text']); ?>"
                                        target="_blank">
                                        <?php echo $getStoreThemeSetting[1]['inner-list'][0]['field_default_text']; ?>
            ...
            <div
                ...
                <div class="col-lg-10 col-xl-8 w-100  position-relative">
                    <div class="swiper-container" data-swiper-items="2" data-swiper-space-between="0"
                        ...
                        <div class="swiper-wrapper">
                            <?php $__currentLoopData = $theme9_product_random; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kei => $headerProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide col-md-6 px-0 h-auto">
                                    <div
                                        class="row align-items-center no-gutters h-100 header-bottom <?php echo e($kei == 0 ? 'bg-white' : 'bg-gray-100'); ?>">
                                        <div class="col-md-3">
                                            <div class="p-2">
                                                <a
                                                    href="<?php echo e(route('store.product.product_view', [$store->slug, $headerProduct->id])); ?>">
                                                    <?php if(!empty($headerProduct->is_cover) && \Storage::exists('uploads/is_cover_image/' . $headerProduct->is_cover)): ?>
                                                        <img alt="Image placeholder"
                                                            src="<?php echo e($productImg . $headerProduct->is_cover); ?>"
                                        ...
                                        <div class="col-md-7 pl-4">
                                            <p class="text-small mb-1">
                                                <span class="font-weight-500">
                                                    <?php echo e($headerProduct->product_category()); ?>:
                                                </span>
                                            ...
                                            <span class="mb-0 p-price text-secondary variation_price">
                                                <?php echo e(\App\Models\Utility::priceFormat($headerProduct->price)); ?>

                                            </span>
                                            <span class="mb-0 sub-price ml-4">
                                                <?php echo e(\App\Models\Utility::priceFormat($headerProduct->last_price)); ?>
                                        ...
                                        <div class="col-md-2 text-center">
                                            <a href="javascript:void(0)"type="button" class="add_to_cart"
                                                ...
                                                data-id="<?php echo e($headerProduct->id); ?>">
    ...
    <!-- Products -->
    <section class="bestsellers-section <?php echo e($getStoreThemeSetting[0]['section_enable'] == 'off' ? 'mt-8' : ''); ?>">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <div class="d-flex form-group position-relative">
                                ...
                                <?php echo e(Form::email('email', null, ['class' => 'font-size-12 pl-5 form-control h-100 py-3 rounded-0 border-0 bg-white shadow-none', 'aria-label' => 'Enter your email address', 'placeholder' => __('Enter Your Email Address')])); ?>
                                                ...
                                                <?php if(!empty($wishlist) && isset($wishlist[$topRatedProduct->product->id]['product_id'])): ?>
                                                    <?php if($wishlist[$topRatedProduct->product->id]['product_id'] != $topRatedProduct->product->id): ?>
                                                        <button data-toggle="tooltip" data-original-title="Wishlist"
                                                            type="button"
                                                            class="badge badge-primary border-0 p-0 position-absolute px-2 py-2 right-4 rounded-circle top-3 zindex-100  add_to_wishlist wishlist_<?php echo e($topRatedProduct->product->id); ?>"
                                        ...
                                        <div class="card-body pt-0 pb-4 px-4 px-md-3 px-lg-4">
                                            ...
                                            <div class="mb-3">
                                                <span class="font-size-12 font-weight-600 text-primary">
                                                    ...
                                                    <?php echo e($topRatedProduct->product->product_rating()); ?> /
                                                    <?php echo e(__('5.0')); ?>
                ...
                <div class="container pb-5 py-md-0">
                    <div class="row">
                        ...
                        <div class="col-md-6 mx-auto">
                            <div class="position-relative">
                                <?php $__currentLoopData = $mostPurchased; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a
                                        href="<?php echo e(route('store.product.product_view', [$store->slug, $product->productImg($product->product_id)->id])); ?>">
                                        <?php if(!empty($product->productImg($product->product_id)->is_cover) &&
                                            \Storage::exists('uploads/is_cover_image/' . $product->productImg($product->product_id)->is_cover)): ?>
                                            <img alt="Image placeholder"
                                                src="<?php echo e($productImg . $product->productImg($product->product_id)->is_cover); ?>"
                        ...
                        <div class="col-md-6 mb-4 mb-md-0 pt-5">
                            ...
                            <?php $__currentLoopData = $mostPurchased; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('store.product.product_view', [$store->slug, $product->productImg($product->product_id)->id])); ?>"
                                    class="btn btn-primary px-6 rounded-pill text-capitalize">
                                    <?php echo e($homepage_header_btn); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="py-md-5 py-4 px-4 service-item">
                                            ...
                                            <p class="font-size-12 text-white">
                                                <?php echo e($storethemesetting['homepage-promotions-description'][$i]); ?></p>
                                        </div>
                                    </div>
                                <?php endfor; ?>
                            <?php else: ?>
                                <?php for($i = 0; $i < $storethemesetting['loop_number']; $i++): ?>
                                    <div class="col-md-4">
                                        <div class="py-md-5 py-4 px-4 service-item">
                                            ...
                                            <h5 class="font-weight-500 text-white mb-3">
                                                <?php echo e($storethemesetting['inner-list'][1]['field_default_text']); ?></h5>
                                            </h5>
                                            <p class="font-size-12 text-white">
                                                <?php echo e($storethemesetting['inner-list'][2]['field_default_text']); ?></p>
                                        </div>
                                    </div>
                                <?php endfor; ?>
                            <?php endif; ?>
        ...
        <div class="container">
            <div class="col-12 d-flex align-items-center justify-content-between ">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="index-categories px-1">
                            <a href="#<?php echo preg_replace('/[^A-Za-z0-9\-]/', '_', $category); ?>" data-id="<?php echo e($key); ?>"
                                class="<?php echo e($key == 0 ? 'active' : ''); ?> productTab bg-primary" id="electronic-tab"
                ...
                <div class="col-md-6 text-md-right">
                    <a href="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>"
                        class="btn btn-primary"><?php echo e(__('GO TO SHOP')); ?></a>
                </div>
        ...
        <div class="container">
            ...
            <div class="bestsellers-tabs mt-5">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-12 px-0 tab-content row <?php echo e($key == 'Start shopping' ? 'active ' : ''); ?> "
                    ...
                    <?php if($key_c < 2): ?>
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="item overflow-hidden position-relative rounded-lg category-1">
                                <?php if(!empty($category->categorie_img) && \Storage::exists('uploads/product_image/' . $category->categorie_img)): ?>
                                    <img alt="Image placeholder"
                ...
                <div class="container pt-md-9">
                    <div class="row align-items-center">
                        <div class="col-md-8 col-lg-6 text-center mx-auto">
                            <h2 class="store-title text-white">
                                <span class="font-weight-600">
                                    <?php echo e($homepage_header_sub_title); ?>
                            ...
                            <div>
                                <a href="<?php echo e(route('store.categorie.product', [$store->slug, 'Start shopping'])); ?>"
                                    class="btn btn-outline-white mt-4 mr-4"><?php echo e($homepage_header_btn); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="slice categorie-section pt-6 pb-4 position-relative">
            <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                <div class="mb-5 text-center">
                                    <h2 class="my-3 text-primary text-uppercase font-weight-600"><?php echo e($Title); ?></h2>
                ...
                <div class="row mx-n2">
                    ...
                    <?php $__currentLoopData = $pro_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro_categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            class="col-sm-6  px-2 mb-3 mb-md-0 <?php echo e(count($pro_categories) == 4 ? 'col-md-3' : 'col-md-4'); ?>">
                            <div class="cat-box overflow-hidden position-relative rounded-lg">
                                ...
                                <div
                                    ...
                                    <a href="<?php echo e(route('store.categorie.product', [$store->slug, $pro_categorie->name])); ?>"
                                        class="btn btn-white rounded-pill text-primary btn-block "><?php echo e(__('VIEW')); ?></a>
        ...
        <section class="slice testimonial-section pb-md-7 pt-md-5">
            <div class="container pt-4">
                <h2 class="text-center text-primary title-size mb-3">
                    <?php echo e($getStoreThemeSetting[7]['inner-list'][0]['field_default_text']); ?></h2>
...
<?php echo $__env->make('storefront.layout.theme9', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme9/index.blade.php ENDPATH**/ ?>