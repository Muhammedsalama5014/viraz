...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme9/css/swiper.min.css')); ?>" id="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme9/css/purpose.css')); ?>" id="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme9/css/all.min.css')); ?>" id="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/theme9/css/storego.css')); ?>" id="stylesheet">
    

    <link rel="stylesheet"
        href="<?php echo e(asset('assets/theme9/css/' . (!empty($store->store_theme) ? $store->store_theme : 'black-color.css'))); ?>">
...
<body>
    ...
    <header class="header" id="header-main">
        ...
        ?>
        <nav class="navbar navbar-main navbar-expand-lg navbar-transparent py-2 <?php echo e($getStoreThemeSetting[0]['section_enable'] == 'off' ? 'bg-dark' : ''); ?><?php echo e($bg_dark); ?>"
            id="navbar-main">
            <div class="container px-lg-0">
                ...
                <div class="collapse navbar-collapse align-items-start" id="navbar-main-collapse">
                    ...
                    <!-- Logo -->
                    <a class="navbar-brand mr-0 d-lg-block d-none" href="<?php echo e(route('store.slug', $store->slug)); ?>">
                        <?php if(!empty($store->logo)): ?>
                            <img alt="Image placeholder"
                                src="<?php echo e($s_logo . $store->logo); ?>" id="navbar-logo">
                        <?php else: ?>
                            <img alt="Image placeholder"
                                src="<?php echo e(asset(Storage::url('uploads/store_logo/logo7.png'))); ?>" id="navbar-logo">
                        <?php endif; ?>
                    </a>
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto nav-my-store">
                        <li class="nav-item align-items-center d-flex nav-item mr-3">
                            ...
                            <a href="<?php echo e(route('store.cart', $store->slug)); ?>" class="nav-cart btn icon-font">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('change.languagestore', [$store->slug, $language])); ?>"
                                        class="dropdown-item font-size-12 text-capitalize <?php if($language == $currantLang): ?> active-language text-primary <?php endif; ?>">
                        ...
                        <?php if(isset($storethemesetting['section_name']) &&
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                ...
                                <p class="font-size-12 text-white">
                                    <?php echo e(__('Enter your address and accept the activation link')); ?></p>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $storethemesetting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $storethemesetting['inner-list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyy => $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($theme['field_name'] == 'Enable Quick Link 1'): ?>
                                            <?php if($getStoreThemeSetting[9]['inner-list'][0]['field_default_text'] == 'on'): ?>
                                                <?php if(!empty($getStoreThemeSetting[9])): ?>
                                                    <?php if((isset($getStoreThemeSetting[9]['section_enable']) && $getStoreThemeSetting[9]['section_enable'] == 'on') ||
                                                        $getStoreThemeSetting[9]['inner-list'][1]['field_default_text']): ?>
                                                        <div class="col-4">
                                                            <h6
                                                                class="font-size-12 heading ls-2 mb-3 text-uppercase text-white">
                                                                <?php echo e(__($getStoreThemeSetting[9]['inner-list'][1]['field_default_text'])); ?>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <?php if(isset(
                                                                    ...
                                                                    <?php $__currentLoopData = $getStoreThemeSetting[10]['homepage-header-quick-link-name-1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name_key => $storethemesettingname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php $__currentLoopData = $getStoreThemeSetting[10]['homepage-header-quick-link-1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link_key => $storethemesettinglink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($name_key == $link_key): ?>
                                                                                <li><a class="font-size-12 text-white"
                                                                                        href="<?php echo e($storethemesettinglink); ?>"><?php echo e($storethemesettingname); ?></a>
                                                                                </li>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php else: ?>
                                                                    <?php for($i = 0; $i < $getStoreThemeSetting[10]['loop_number']; $i++): ?>
                                                                        <li><a class="font-size-12 text-white"
                                                                                href="<?php echo e($getStoreThemeSetting[10]['inner-list'][1]['field_default_text']); ?>">
                                                                                <?php echo e($getStoreThemeSetting[10]['inner-list'][0]['field_default_text']); ?>
                                            ...
                                            <?php if($getStoreThemeSetting[11]['inner-list'][0]['field_default_text'] == 'on'): ?>
                                                <?php if(!empty($getStoreThemeSetting[11])): ?>
                                                    <?php if((isset($getStoreThemeSetting[11]['section_enable']) &&
                                                        $getStoreThemeSetting[11]['section_enable'] == 'on') ||
                                                        $getStoreThemeSetting[11]['inner-list'][1]['field_default_text']): ?>
                                                        <div class="col-4">
                                                            <h6
                                                                class="font-size-12 heading ls-2 mb-3 text-uppercase text-white">
                                                                <?php echo e(__($getStoreThemeSetting[11]['inner-list'][1]['field_default_text'])); ?>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <?php if(isset(
                                                                    ...
                                                                    <?php $__currentLoopData = $getStoreThemeSetting[12]['homepage-header-quick-link-name-2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name_key => $storethemesettingname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php $__currentLoopData = $getStoreThemeSetting[12]['homepage-header-quick-link-2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link_key => $storethemesettinglink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($name_key == $link_key): ?>
                                                                                <li><a class="font-size-12 text-white"
                                                                                        href="<?php echo e($storethemesettinglink); ?>">
                                                                                        <?php echo e($storethemesettingname); ?></a>
                                                                                </li>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php else: ?>
                                                                    <?php for($i = 0; $i < $getStoreThemeSetting[12]['loop_number']; $i++): ?>
                                                                        <li><a class="font-size-12 text-white"
                                                                                href="<?php echo e($getStoreThemeSetting[12]['inner-list'][1]['field_default_text']); ?>">
                                                                                <?php echo e($getStoreThemeSetting[12]['inner-list'][0]['field_default_text']); ?></a>
                                                                        </li>
                                                                    <?php endfor; ?>
                                                                <?php endif; ?>
                                            ...
                                            <?php if($getStoreThemeSetting[13]['inner-list'][1]['field_default_text'] == 'on'): ?>
                                                <?php if(!empty($getStoreThemeSetting[13])): ?>
                                                    <?php if((isset($getStoreThemeSetting[13]['section_enable']) &&
                                                        $getStoreThemeSetting[13]['section_enable'] == 'on') ||
                                                        $getStoreThemeSetting[13]['inner-list'][1]['field_default_text']): ?>
                                                        <div class="col-4">
                                                            <h6
                                                                class="font-size-12 heading ls-2 mb-3 text-uppercase text-white">
                                                                <?php echo e(__($getStoreThemeSetting[13]['inner-list'][0]['field_default_text'])); ?>
                                                            ...
                                                            <ul class="list-unstyled">
                                                                <?php if(isset(
                                                                    ...
                                                                    <?php $__currentLoopData = $getStoreThemeSetting[14]['homepage-header-quick-link-name-3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name_key => $storethemesettingname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php $__currentLoopData = $getStoreThemeSetting[14]['homepage-header-quick-link-3']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link_key => $storethemesettinglink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($name_key == $link_key): ?>
                                                                                <li><a class="font-size-12 text-white"
                                                                                        href="<?php echo e($storethemesettinglink); ?>">
                                                                                        <?php echo e($storethemesettingname); ?></a>
                                                                ...
                                                                <?php else: ?>
                                                                    <?php for($i = 0; $i < $getStoreThemeSetting[14]['loop_number']; $i++): ?>
                                                                        <li><a class="font-size-12 text-white"
                                                                                ...
                                                                                <?php echo e($getStoreThemeSetting[14]['inner-list'][0]['field_default_text']); ?></a>
                                                                        </li>
                                                                    <?php endfor; ?>
                                                                <?php endif; ?>
                ...
                <div class="pb-4 row">
                    <div class="d-sm-flex col-12 text-center text-md-left justify-content-between">
                        <div class="copyright font-size-12 text-md-left text-white">
                            <?php if($getStoreThemeSetting[15]['section_enable'] == 'on'): ?>
                        ...
                        <?php if($getStoreThemeSetting[15]['section_enable'] == 'on'): ?>
                            ...
                            <ul class="list-inline footer-social mb-0">
                                <?php if(isset($getStoreThemeSetting[16]['homepage-footer-2-social-icon']) ||
                                    isset($getStoreThemeSetting[16]['homepage-footer-2-social-link'])): ?>
                                    <?php if(isset($getStoreThemeSetting[16]['inner-list'][1]['field_default_text']) &&
                                        isset($getStoreThemeSetting[16]['inner-list'][0]['field_default_text'])): ?>
                                        <?php $__currentLoopData = $getStoreThemeSetting[16]['homepage-footer-2-social-icon']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon_key => $storethemesettingicon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $__currentLoopData = $getStoreThemeSetting[16]['homepage-footer-2-social-link']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link_key => $storethemesettinglink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php for($i = 0; $i < $getStoreThemeSetting[16]['loop_number']; $i++): ?>
                                        <?php if(isset($getStoreThemeSetting[16]['inner-list'][1]['field_default_text']) &&
                                            isset($getStoreThemeSetting[16]['inner-list'][0]['field_default_text'])): ?>
                                            <li class="d-inline-block mr-3">
                                                <a class="d-flex align-items-center justify-content-center footer-icon"
                                                    href="<?php echo e($getStoreThemeSetting[16]['inner-list'][1]['field_default_text']); ?>"
                                                    target="_blank">
                                                    <?php echo $getStoreThemeSetting[16]['inner-list'][0]['field_default_text']; ?>
    ...
    <script src="<?php echo e(asset('assets/theme9/js/purpose.core.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme9/js/swiper.min.js')); ?>"></script>
    <script href="<?php echo e(asset('assets/theme9/js/storego.js')); ?>"></script>
    <script href="<?php echo e(asset('assets/theme9/js/regular.js')); ?>"></script>
    <script src="<?php echo e(asset('custom/libs/bootstrap-notify/bootstrap-notify.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/theme9/js/purpose.js')); ?>"></script>
    <script>
        var dataTabelLang = {
            paginate: {
...
<?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/layout/theme9.blade.php ENDPATH**/ ?>