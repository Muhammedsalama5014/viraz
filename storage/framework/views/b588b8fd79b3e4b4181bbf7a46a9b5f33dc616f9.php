        ...
        <div class="main-content position-relative bg-white">
            <div class="container">
                <div class="card-group mt-7">
                    ...
                    <div class="row row-grid">
                        <div class="col-lg-6">
                            <img class="p-img"  src="<?php echo e($proimg.$products->is_cover); ?>" alt="shofe" title="shofe image">
                        </div>
                        <div class="col-lg-6">
                            <div class="pd-rate">
                                ...
                                <div class="card-image">
                                    <a href="<?php echo e(route('store.product.product_view',[$store->slug,$product->id])); ?>">
                                        <?php if(!empty($product->is_cover) && \Storage::exists('uploads/is_cover_image/'.$product->is_cover)): ?>
                                            <img alt="Image123 placeholder" src="<?php echo e($proimg.$product->is_cover); ?>" class="img-center img-fluid">
                                        <?php else: ?>
...
<?php echo $__env->make('storefront.layout.theme2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme2/view.blade.php ENDPATH**/ ?>