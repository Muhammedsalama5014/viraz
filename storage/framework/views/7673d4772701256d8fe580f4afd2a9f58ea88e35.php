                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="pr-title mb-4">
                            <h3 class=" mt-4 store-title"><?php echo e(__('My Cart')); ?></h3>
                                ...
                                <?php $__currentLoopData = $products['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php else: ?>
                                        <tr class="alert" data-id="<?php echo e($key); ?>">
                                            <td>
                                                <?php if(!empty($product['image'])): ?>
                                                    <img alt="Image placeholder" src="<?php echo e($imgpath.$product['image']); ?>" class="" style="width:66px;">
                                                <?php else: ?>
...
<?php echo $__env->make('storefront.layout.theme3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme3/cart.blade.php ENDPATH**/ ?>