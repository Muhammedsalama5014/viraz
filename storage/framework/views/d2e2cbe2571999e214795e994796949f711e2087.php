                ...
                <div class="row row-grid">
                    <div class="col-xl-8 col-lg-7">
                        ...
                        <div class="actions-toolbar py-2 mb-4">
                            <h5 class="mb-1 text-primary"><?php echo e(__('Billing information')); ?></h5>
                        ...
                        <div class="actions-toolbar py-2 mb-4 shop-title">
                            <div class="left-cart">
                                <h5 class="mb-1 text-primary"><?php echo e(__('Shipping informations')); ?></h5>
                                <p class="text-sm text-muted mb-0"><?php echo e(__('Fill the form below so we can send you the orders invoice.')); ?></p>
                            </div>
                        ...
                        <div data-toggle="sticky" data-sticky-offset="30">
                            <div class="card" id="card-summary">
                                <div class="card-header b-0 py-3">
                                    <div class="row align-items-center">
                                        <h3 class="ml-3 store-title-medium text-primary"><?php echo e(__('Summary')); ?></h3>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('storefront.layout.theme1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/storefront/theme1/shipping.blade.php ENDPATH**/ ?>