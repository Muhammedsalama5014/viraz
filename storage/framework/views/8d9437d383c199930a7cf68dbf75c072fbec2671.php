                                        ...
                                        <div class="card my-3">
                                            <div class="card-header">
                                                <div class="row flex-grow-1">
                                                    ...
                                                    <?php if(empty($productVariantArrays)): ?>
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col ml-n2">
                                                                <p class="card-text small text-muted">
                                                                    <img class="rounded"
                                                                        src=" <?php echo e($productimage . $file->product_images); ?>"
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item"
                                                                    href=" <?php echo e($product_image. $file->product_images); ?>"
                                            ...
                                            <div class="px-3 py-3">
                                                <div class="row align-items-center">
                                                    <div class="col ml-n2">
                                                        <p class="card-text small text-muted">
                                                            <img class="rounded"
                                                                src=" <?php echo e($is_cover_image . $product->is_cover); ?>"
                                                                width="70px" alt="Image placeholder" data-dz-thumbnail>
                                                        </p>
                                                    </div>
                                                    <div class="col-auto actions">
                                                        <a class="action-item"
                                                            href=" <?php echo e($is_cover_image . $product->is_cover); ?>"
                                                            download="" data-toggle="tooltip"
                                                            data-original-title="<?php echo e(__('Download')); ?>">
                                                            <i class="fas fa-download"></i>
                                                        </a>
...
$(document).on('click', '.add-variants', function (e) {
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function (data) {
                        $('#hiddenVariantOptions').val(data.hiddenVariantOptions);
                        console.log(data.varitantHTML,data);
                        $('.variant-table').html(data.varitantHTML);
                        $("#commonModal").modal('hide');
                    }
                })
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389444621/domains/viraz.co/public_html/resources/views/product/edit.blade.php ENDPATH**/ ?>