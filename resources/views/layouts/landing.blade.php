...
<head>
    ...
    <!-- Stylesheets -->
    <link href="{{asset('public/new/css/bootstrap.css')}}" rel="stylesheet">
    <link href="{{asset('public/new/css/main.css')}}" rel="stylesheet">
    <link href="{{asset('public/new/css/responsive.css')}}" rel="stylesheet">

    <link rel="shortcut icon" href="{{asset('public/new/images/favicon.png')}}" type="image/x-icon">
    <link rel="icon" href="{{asset('public/new/images/favicon.png')}}" type="image/x-icon">
...
<div class="page-wrapper">
    ...
    <header class="main-header">
                ...
                <div class="clearfix">
                    ...
                    <div class="pull-left logo-box">
                        <div class="logo"><a href="{{url('/')}}">
                                <img style="width: 105px;" src="{{$logo.(isset($logo_light) && !empty($logo_light)?$logo_light:'logo-light.png')}}" alt="" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="outer-box">
                         ...
                         <div class="outer-box">
                            <a href="{{ url('/register') }}" class="theme-btn btn-style-one"><span class="txt">Sign up</span></a>
                        </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="{{url('/')}}"><img style="width: 105px;" src="{{$logo.(isset($logo_light) && !empty($logo_light)?$logo_light:'logo-light.png')}}" alt="" title=""></a></div>
    ...
    <section class="banner-section" id="home-banner">
        <div class="patern-layer-one" style="background-image: url({{asset('public/new/images/background/banner-bg.png')}})"></div>
        <div class="bg-layer" style="background-image: url({{asset('public/new/images/background/2.jpg')}})"></div>
        <div class="auto-container">
                    ...
                    <div class="inner-column">
                        ...
                        <div class="video-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <figure class="video-image">
                                <img src="{{asset('public/new/images/resource/video.jpg')}}" alt="">
                            </figure>
                ...
                <div class="carousel-column col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="slider-outer">
                            ...
                            <!-- Column / Slides -->
                            <div class="slides-box" style="background-image: url({{asset('public/new/images/resource/mobile.png')}})">
                                <div class="inner-box">
                                    ...
                                    <div class="banner-slider">
                                        ...
                                        <div class="slide-item">
                                            <div class="image">
                                                <img src="{{asset('public/new/images/resource/search.png')}}" alt=""/>
                                            </div>
                                        </div>

                                        <div class="slide-item">
                                            <div class="image">
                                                <img src="{{asset('public/new/images/resource/screenshot01.png')}}" alt=""/>
                                            </div>
                                        </div>

                                        <div class="slide-item">
                                            <div class="image">
                                                <img src="{{asset('public/new/images/resource/slider-05.png')}}" alt=""/>
                                            </div>
                                        </div>
                                ...
                                <div class="mobile-small-image">
                                    <img src="{{asset('public/new/images/resource/play.png')}}" alt=""/>
                                </div>

                                <div class="heart-image-icon">
                                    <img src="{{asset('public/new/images/icons/heart.png')}}" alt=""/>
                                </div>

                                <div class="plus-small-image">
                                    <img src="{{asset('public/new/images/icons/plus.png')}}" alt=""/>
                                </div>
                ...
                <div class="blocks-column col-lg-7 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="cloud-icon">
                            <img src="{{asset('public/new/images/icons/cloud-icon.png')}}" alt=""/>
                        </div>
                        <div class="row clearfix">
                        ...
                        <div class="side-image">
                            <img src="{{asset('public/new/images/resource/girl-icon.png')}}" alt=""/>
                        </div>
    ...
    <section class="steps-section">
        <div class="patern-layer-one" style="background-image: url({{asset('public/new/images/background/pattern-2.png')}})"></div>
        <div class="patern-layer-two" style="background-image: url({{asset('public/new/images/background/pattern-3.png')}})"></div>
        <div class="patern-layer-three" style="background-image: url({{asset('public/new/images/background/pattern-4.png')}})"></div>
        <div class="auto-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="carousel-column col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="carousel-inner" role="listbox"
                             style="background-image: url({{asset('public/new/images/resource/mobile.png')}})">
                            <div class="slides">

                                <div class="carousel-item active">
                                    <div class="content">
                                        <div class="image">
                                            <a href="{{asset('public/new/images/resource/mokeup-1.jpg')}}" data-fancybox="steps" data-caption=""
                                               class="image-link lightbox-image"><img src="{{asset('public/new/images/resource/mokeup-1.jpg')}}"
                                                                                      alt=""/></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="content">
                                        <div class="image">
                                            <a href="{{asset('public/new/images/resource/mokeup-2.jpg')}}" data-fancybox="steps" data-caption=""
                                               class="image-link lightbox-image"><img src="{{asset('public/new/images/resource/mokeup-2.jpg')}}"
                                                                                      alt=""/></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="content">
                                        <div class="image">
                                            <a href="{{asset('public/new/images/resource/mokeup-3.jpg')}}" data-fancybox="steps" data-caption=""
                                               class="image-link lightbox-image"><img src="{{asset('public/new/images/resource/mokeup-3.jpg')}}"
                                                                                      alt=""/></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="image-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="image titlt" data-tilt data-tilt-max="8">
                                    <a href="{{asset('public/new/images/resource/app-1.png')}}" class="app-1 lightbox-image"><img
                                            src="{{asset('public/new/images/resource/dash-board.png')}}" alt=""/></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="image-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="image titlt" data-tilt data-tilt-max="8">
                                    <a href="{{asset('public/new/images/resource/app-2.png')}}" class="app-2 lightbox-image"><img
                                            src="{{asset('public/new/images/resource/app-2.png')}}" alt=""/></a>
                                </div>
                                <div class="small-image titlt wow slideInRight" data-wow-delay="300ms"
                                     data-wow-duration="1500ms" data-tilt data-tilt-max="15">
                                    <a href="{{asset('public/new/images/resource/app-3.png')}}" class="app-2 lightbox-image"><img
                                            src="{{asset('public/new/images/resource/app-3.png')}}" alt=""/></a>
                                </div>
                            </div>
                        </div>
    ...
    <section class="counter-section">
        <div class="patern-layer-one" style="background-image: url({{asset('public/new/images/background/pattern-5.png')}})"></div>
        <div class="patern-layer-two" style="background-image: url({{asset('public/new/images/background/pattern-6.png')}})"></div>
        <div class="patern-layer-three" style="background-image: url({{asset('public/new/images/background/pattern-7.png')}})"></div>
        <div class="patern-layer-four" style="background-image: url({{asset('public/new/images/background/pattern-8.png')}})"></div>
        <!-- Flower Image -->
        <div class="flower-image">
            <!-- Image One -->
            <div class="image paroller" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
                 data-paroller-type="foreground" data-paroller-direction="horizontal"
                 style="background-image:url({{asset('public/new/images/resource/flower.png')}})"></div>
        </div>
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="google-btns">
                            <a href="#"><img src="{{asset('public/new/images/icons/google.png')}}" alt=""/></a>
                            <a href="#"><img src="{{asset('public/new/images/icons/app.png')}}" alt=""/></a>
                        </div>
                    </div>
                </div>
            ...
            <div id="carousel-thumb" class="carousel slide carousel-thumbnails" data-ride="carousel">
                <div class="row clearfix">
                    ...
                    <div class="pagers-column col-lg-6 col-md-12 col-sm-12">
                        <div class="pattern-layer" style="background-image: url({{asset('public/new/images/background/pattern-9.png')}})"></div>
                        <!-- Controls-->
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-thumb" data-slide-to="0" class="active">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-1.jpg')}}" alt="">
                                </div>
                            </li>
                            <li data-target="#carousel-thumb" data-slide-to="1">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-2.jpg')}}" alt="">
                                </div>
                            </li>
                            <li data-target="#carousel-thumb" data-slide-to="2">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-3.jpg')}}" alt="">
                                </div>
                            </li>
                            <li data-target="#carousel-thumb" data-slide-to="3">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-4.jpg')}}" alt="">
                                </div>
                            </li>
                            <li data-target="#carousel-thumb" data-slide-to="4">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-5.jpg')}}" alt="">
                                </div>
                            </li>
                            <li data-target="#carousel-thumb" data-slide-to="5">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-6.jpg')}}" alt="">
                                </div>
                            </li>
                            <li data-target="#carousel-thumb" data-slide-to="6">
                                <div class="image img-circle"><img src="{{asset('public/new/images/resource/author-thumb-7.jpg')}}" alt="">
                                </div>
                            </li>
                        </ol>
                    </div>
                                ...
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            ...
                                            <img src="{{asset('public/new/images/resource/author-thumb-1.jpg')}}" alt=""/>
                                        </div>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            <span class="social-icon fa fa-facebook-square"></span>
                                            <img src="{{asset('public/new/images/resource/author-thumb-2.jpg')}}" alt=""/>
                                        </div>
                                        <div class="quote-icon icons-right-quote-sign"></div>
                                        <div class="slide-text">“ Lorem Ipsum is simply dummy text of the printing and
                                            type <br> setting industry. Lorem Ipsum has been the industry's stan <br>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            <span class="social-icon fa fa-facebook-square"></span>
                                            <img src="{{asset('public/new/images/resource/author-thumb-3.jpg')}}" alt=""/>
                                        </div>
                                        <div class="quote-icon icons-right-quote-sign"></div>
                                        <div class="slide-text">“ Lorem Ipsum is simply dummy text of the printing and
                                            type <br> setting industry. Lorem Ipsum has been the industry's stan <br>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            <span class="social-icon fa fa-facebook-square"></span>
                                            <img src="{{asset('public/new/images/resource/author-thumb-4.jpg')}}" alt=""/>
                                        </div>
                                        <div class="quote-icon icons-right-quote-sign"></div>
                                        <div class="slide-text">“ Lorem Ipsum is simply dummy text of the printing and
                                            type <br> setting industry. Lorem Ipsum has been the industry's stan <br>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            <span class="social-icon fa fa-facebook-square"></span>
                                            <img src="{{asset('public/new/images/resource/author-thumb-5.jpg')}}" alt=""/>
                                        </div>
                                        <div class="quote-icon icons-right-quote-sign"></div>
                                        <div class="slide-text">“ Lorem Ipsum is simply dummy text of the printing and
                                            type <br> setting industry. Lorem Ipsum has been the industry's stan <br>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            <span class="social-icon fa fa-facebook-square"></span>
                                            <img src="{{asset('public/new/images/resource/author-thumb-6.jpg')}}" alt=""/>
                                        </div>
                                        <div class="quote-icon icons-right-quote-sign"></div>
                                        <div class="slide-text">“ Lorem Ipsum is simply dummy text of the printing and
                                            type <br> setting industry. Lorem Ipsum has been the industry's stan <br>
                            ...
                            <div class="carousel-item">
                                <div class="testimonial-block">
                                    <div class="inner-box">
                                        <div class="author-image">
                                            <span class="social-icon fa fa-facebook-square"></span>
                                            <img src="{{asset('public/new/images/resource/author-thumb-7.jpg')}}" alt=""/>
                                        </div>
                                        <div class="quote-icon icons-right-quote-sign"></div>
                                        <div class="slide-text">“ Lorem Ipsum is simply dummy text of the printing and
                                            type <br> setting industry. Lorem Ipsum has been the industry's stan <br>
        ...
        <div class="auto-container">
            ...
            <div class="row appScreenshotCarousel-container swiper-container">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-01.jpg')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-02.png')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-03.png')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-04.png')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-05.png')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-02.png')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-01.jpg')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-02.png')}})"></div>
                    <div class="swiper-slide" style="background-image:url({{asset('public/new/images/resource/slider-03.png')}})"></div>
    ...
    <section class="integration-section">
        <div class="patern-layer-one" style="background-image: url({{asset('public/new/images/background/pattern-5.png')}})"></div>
        <div class="patern-layer-two" style="background-image: url({{asset('public/new/images/background/pattern-6.png')}})"></div>
        <div class="patern-layer-three" style="background-image: url({{asset('public/new/images/background/pattern-10.png')}})"></div>
        <div class="patern-layer-four" style="background-image: url({{asset('public/new/images/background/pattern-11.png')}})"></div>
        <div class="auto-container">
            ...
            <div class="bubbles-wrapper">
                <div class="animations m-0">
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-md">
                        <img src="{{asset('public/new/images/resource/Integrations-1.jpg')}}" alt="" class="img-responsive">
                    ...
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-xxl">
                        <img src="{{asset('public/new/images/resource/Integrations-2.jpg')}}" alt="" class="img-responsive">
                    ...
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-lg">
                        <img src="{{asset('public/new/images/resource/Integrations-3.jpg')}}" alt="" class="img-responsive">
                    ...
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-xl">
                        <img src="{{asset('public/new/images/resource/Integrations-4.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Fingerprint</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-md">
                        <img src="{{asset('public/new/images/resource/Integrations-5.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Amplify</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-lg">
                        <img src="{{asset('public/new/images/resource/Integrations-6.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Firebase Integration</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-md">
                        <img src="{{asset('public/new/images/resource/Integrations-7.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Google-Plus</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-xl">
                        <img src="{{asset('public/new/images/resource/Integrations-8.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Jio Tv</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-lg">
                        <img src="{{asset('public/new/images/resource/Integrations-9.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Paypal</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-xxl">
                        <img src="{{asset('public/new/images/resource/Integrations-10.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Stripe</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-md">
                        <img src="{{asset('public/new/images/resource/Integrations-11.jpg')}}" alt="" class="img-responsive">
                        <span class="badge badge-contrast shadow-box">Goola Map</span>
                    </div>
                    <div class="bubble bg-contrast rounded-circle p-2 shadow icon icon-xl">
                        <img src="{{asset('public/new/images/resource/Integrations-12.jpg')}}" alt="" class="img-responsive">
            ...
            <div class="pricing-tabs tabs-box">
                ...
                <div class="tabs-content">
                    ...
                    <div class="patern-layer-three paroller" data-paroller-factor="0.30" data-paroller-factor-lg="0.60"
                         data-paroller-type="foreground" data-paroller-direction="horizontal"
                         style="background-image: url({{asset('public/new/images/icons/pattern-19.png')}})"></div>
                    <div class="patern-layer-four paroller" data-paroller-factor="-0.30" data-paroller-factor-lg="0.60"
                         data-paroller-type="foreground" data-paroller-direction="horizontal"
                         style="background-image: url({{asset('public/new/images/icons/pattern-20.png')}})"></div>
                                ...
                                <div class="price-block col-lg-4 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="patern-layer-two"
                                             style="background-image: url({{asset('public/new/images/icons/pattern-18.png')}})"></div>
                                        <div class="patern-layer-one"
                                             style="background-image: url({{asset('public/new/images/icons/pattern-17.png')}})"></div>
                                        <div class="upper-box">
                                            <div class="icon-box">
            ...
            <div class="row clearfix">
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="blog-single.html"><img src="{{asset('public/new/images/resource/news-1.png')}}" alt=""/></a>
                        </div>
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="blog-single.html"><img src="{{asset('public/new/images/resource/news-2.png')}}" alt=""/></a>
                        </div>
                        <div class="lower-content">
                            <ul class="post-meta">
                                <li><span class="icon icons-calendar-2"></span>September 12, 2020</li>
                ...
                <div class="news-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="blog-single.html"><img src="{{asset('public/new/images/resource/news-3.png')}}" alt=""/></a>
                        </div>
                        <div class="lower-content">
                            <ul class="post-meta">
                                <li><span class="icon icons-calendar-2"></span>September 12, 2020</li>
            ...
            <div class="team-carousel owl-carousel owl-theme">
                ...
                <div class="team-block">
                    <div class="inner-box">
                        <div class="image-outer">
                            <div class="image">
                                <a href="#"><img src="{{asset('public/new/images/resource/team-1.png')}}" alt=""/></a>
                            </div>
                        </div>
                        <div class="lower-content">
                            <h3>Romeo Poro</h3>
                ...
                <div class="team-block style-two">
                    <div class="inner-box">
                        <div class="image-outer">
                            <div class="image">
                                <a href="#"><img src="{{asset('public/new/images/resource/team-2.png')}}" alt=""/></a>
                            </div>
                        </div>
                        <div class="lower-content">
                            <h3>David Roger</h3>
                ...
                <div class="team-block style-three">
                    <div class="inner-box">
                        <div class="image-outer">
                            <div class="image">
                                <a href="#"><img src="{{asset('public/new/images/resource/team-3.png')}}" alt=""/></a>
                            </div>
                        </div>
                        <div class="lower-content">
                            <h3>Jasmin Duke</h3>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="info-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="patern-layer-one"
                             style="background-image: url({{asset('public/new/images/background/pattern-12.png')}})"></div>
                        <div class="patern-layer-two"
                             style="background-image: url({{asset('public/new/images/background/pattern-13.png')}})"></div>
                        <div class="patern-layer-three paroller" data-paroller-factor="-0.10"
                             ...
                             style="background-image: url({{asset('public/new/images/background/pattern-14.png')}})"></div>
                        <ul class="info-list">
                            <li>
    ...
    <section class="subscribe-section">
        <div class="patern-layer-one" style="background-image: url({{asset('public/new/images/background/pattern-15.png')}})"></div>
        <div class="auto-container">
            <div class="sec-title centered style-four">
                ...
                <div class="row clearfix">
                    ...
                    <div class="footer-column col-lg-4 col-md-6 col-sm-12">
                        <div class="footer-widget logo-widget">
                            <div class="logo">
                                <a href="{{url('/')}}"><img style="width: 105px;" src="{{$logo.(isset($logo_light) && !empty($logo_light)?$logo_light:'logo-light.png')}}" alt=""/></a>
                            </div>
                            <div class="text">Lorem Ipsum is simply dummy text <br> of the printing and type.</div>
                            <div class="paypall">
                                <a href="#"><img src="{{asset('public/new/images/icons/paypall.png')}}" alt=""/></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="footer-column col-lg-4 col-md-6 col-sm-12">
                        <div class="footer-widget email-widget">
                            ...
                            <div class="btns">
                                <a href="#"><img src="{{asset('public/new/images/icons/app-1.png')}}" alt=""/></a>
                                <a href="#"><img src="{{asset('public/new/images/icons/google-1.png')}}')}}" alt=""/></a>
                            </div>
...
<script src="{{asset('public/new/js/jquery.js')}}"></script>
<script src="{{asset('public/new/js/popper.min.js')}}"></script>
<script src="{{asset('public/new/js/pagenav.js')}}"></script>
<script src="{{asset('public/new/js/jquery.scrollTo.js')}}"></script>
<script src="{{asset('public/new/js/bootstrap.min.js')}}"></script>
<script src="{{asset('public/new/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{asset('public/new/js/jquery.fancybox.js')}}"></script>
<script src="{{asset('public/new/js/appear.js')}}"></script>
<script src="{{asset('public/new/js/swiper.min.js')}}"></script>
<script src="{{asset('public/new/js/jquery.paroller.min.js')}}"></script>
<script src="{{asset('public/new/js/parallax.min.js')}}"></script>
<script src="{{asset('public/new/js/validate.js')}}"></script>
<script src="{{asset('public/new/js/bxslider.js')}}"></script>

<script src="{{asset('public/new/js/swiper.min.js')}}"></script>
<script src="{{asset('public/new/js/tilt.jquery.min.js')}}"></script>
<script src="{{asset('public/new/js/owl.js')}}"></script>
<script src="{{asset('public/new/js/wow.js')}}"></script>
<script src="{{asset('public/new/js/jquery-ui.js')}}"></script>
<script src="{{asset('public/new/js/script.js')}}"></script>
